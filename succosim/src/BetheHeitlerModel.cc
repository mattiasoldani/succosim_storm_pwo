...
const G4int BetheHeitlerModel::gMaxZet = 120;
std::vector<BetheHeitlerModel::ElementData*> BetheHeitlerModel::gElementData;

BetheHeitlerModel::BetheHeitlerModel(const G4ParticleDefinition*,
                                         const G4String& nam)
: G4VEmModel(nam), 
...
void BetheHeitlerModel::Initialise(const G4ParticleDefinition* p,
...
void BetheHeitlerModel::InitialiseLocal(const G4ParticleDefinition*,
...
G4double 
BetheHeitlerModel::ComputeCrossSectionPerAtom(const G4ParticleDefinition*,
...
void BetheHeitlerModel::SampleSecondaries(std::vector<G4DynamicParticle*>* fvect,
...
void BetheHeitlerModel::InitialiseElementData()
{
...
//G4double BetheHeitlerModel::ComputeCorrection(G4double gammaEnergy)
//{
