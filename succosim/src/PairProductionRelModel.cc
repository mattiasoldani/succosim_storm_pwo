...
const G4int PairProductionRelModel::gMaxZet = 120;

// LPM constant: \alpha(mc^2)^2/(4\pi*\hbar c)
const G4double PairProductionRelModel::gLPMconstant =
...
const G4double PairProductionRelModel::gFelLowZet  [] = {
  0.0, 5.3104, 4.7935, 4.7402, 4.7112, 4.6694, 4.6134, 4.5520
};
const G4double PairProductionRelModel::gFinelLowZet[] = {
  0.0, 5.9173, 5.6125, 5.5377, 5.4728, 5.4174, 5.3688, 5.3236
};

// constant cross section factor
const G4double PairProductionRelModel::gXSecFactor =
...
const G4double PairProductionRelModel::gEgLPMActivation = 100.*CLHEP::GeV;

// special data structure per element i.e. per Z 
std::vector<PairProductionRelModel::ElementData*> PairProductionRelModel::gElementData;

// LPM supression functions evaluated at initialisation time
PairProductionRelModel::LPMFuncs PairProductionRelModel::gLPMFuncs;

// CTR
PairProductionRelModel::PairProductionRelModel(const G4ParticleDefinition*,
                                                   const G4String& nam)
  ...
  fParticleChange(nullptr) 
{
  ...
  //correction.set_axis(PairProductionCorrection::PWO_001);
  correction.set_axis(PairProductionCorrection::PWO_100); // added by Mattia, choose
}

// DTR
PairProductionRelModel::~PairProductionRelModel()
{
  if (IsMaster()) {
...
void PairProductionRelModel::Initialise(const G4ParticleDefinition* p,
...
void PairProductionRelModel::InitialiseLocal(const G4ParticleDefinition*,
...
G4double PairProductionRelModel::ComputeXSectionPerAtom(G4double gammaEnergy,
                                                          G4double Z)
{
...
G4double PairProductionRelModel::ComputeDXSectionPerAtom(G4double pEnergy,
...
G4double PairProductionRelModel::ComputeRelDXSectionPerAtom(G4double pEnergy,
                                                           G4double gammaEnergy,
                                                           G4double Z)
{
  G4double xSection = 0.;
...
G4double
PairProductionRelModel::ComputeCrossSectionPerAtom(const G4ParticleDefinition*,
...
void PairProductionRelModel::SetupForMaterial(const G4ParticleDefinition*,
...
void
PairProductionRelModel::SampleSecondaries(std::vector<G4DynamicParticle*>* fvect,
...
void PairProductionRelModel::InitialiseElementData()
{
...
void PairProductionRelModel::InitLPMFunctions() {
...
void PairProductionRelModel::ComputeLPMGsPhis(G4double &funcGS, G4double &funcPhiS, const G4double varShat) {
  if (varShat < 0.01) {
...
void PairProductionRelModel::GetLPMFunctions(G4double &lpmGs,
                                               G4double &lpmPhis, 
                                               const G4double sval) {
...
void PairProductionRelModel::ComputeLPMfunctions(G4double &funcXiS,
...
//G4double PairProductionRelModel::ComputeCorrection(G4double gammaEnergy)
//{
