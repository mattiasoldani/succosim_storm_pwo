...
G4Physics2DVector* SeltzerBergerModelElectron::gSBDCSData[]     = { nullptr };
G4SBBremTable*     SeltzerBergerModelElectron::gSBSamplingTable =   nullptr;
G4double           SeltzerBergerModelElectron::gYLimitData[]    = { 0.0     };

SeltzerBergerModelElectron::SeltzerBergerModelElectron(const G4ParticleDefinition* p,
                                             const G4String& nam)
: eBremsstrahlungRelModel_electron(p,nam), fIsUseBicubicInterpolation(false),
...
SeltzerBergerModelElectron::~SeltzerBergerModelElectron()
{
...
void SeltzerBergerModelElectron::Initialise(const G4ParticleDefinition* p,
...
G4String SeltzerBergerModelElectron::DirectoryPath() const {
  return "/brem_SB/br";
}

void SeltzerBergerModelElectron::ReadData(G4int izet, const char* path) {
...
G4double SeltzerBergerModelElectron::ComputeDXSectionPerAtom(G4double gammaEnergy)
{
...
void
SeltzerBergerModelElectron::SampleSecondaries(std::vector<G4DynamicParticle*>* vdp,
...
G4double
SeltzerBergerModelElectron::SampleEnergyTransfer(const G4double kinEnergy,
                                            const G4double tmin,
                                            const G4double tmax)
{
  static const G4double kMC2   = CLHEP::electron_mass_c2;
...
void SeltzerBergerModelElectron::InitialiseForElement(const G4ParticleDefinition*,
                                                 G4int izet)
{
...
void SeltzerBergerModelElectron::SetupForMaterial(const G4ParticleDefinition*,
