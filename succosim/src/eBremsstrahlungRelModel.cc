...
const G4int eBremsstrahlungRelModel::gMaxZet = 120;

// constant DCS factor: 16\alpha r_0^2/3
const G4double eBremsstrahlungRelModel::gBremFactor
...
const G4double eBremsstrahlungRelModel::gMigdalConstant
...
const G4double eBremsstrahlungRelModel::gLPMconstant
...
const G4double eBremsstrahlungRelModel::gFelLowZet  [] = {
  0.0, 5.3104, 4.7935, 4.7402, 4.7112, 4.6694, 4.6134, 4.5520
};
const G4double eBremsstrahlungRelModel::gFinelLowZet[] = {
  0.0, 5.9173, 5.6125, 5.5377, 5.4728, 5.4174, 5.3688, 5.3236
};

// LPM supression functions evaluated at initialisation time
eBremsstrahlungRelModel::LPMFuncs  eBremsstrahlungRelModel::gLPMFuncs;

// special data structure per element i.e. per Z
std::vector<eBremsstrahlungRelModel::ElementData*> eBremsstrahlungRelModel::gElementData;
///
/// \brief eBremsstrahlungRelModel::eBremsstrahlungRelModel
/// \param p
/// \param nam
/// Основана на модели стандартного Geant4 и наследуется от G4VEmModel
eBremsstrahlungRelModel::eBremsstrahlungRelModel(const G4ParticleDefinition* p,
                                                     const G4String& nam)
...
/// Деструктор
eBremsstrahlungRelModel::~eBremsstrahlungRelModel()
{
  if (IsMaster()) {
...
void eBremsstrahlungRelModel::Initialise(const G4ParticleDefinition* p,
...
void eBremsstrahlungRelModel::InitialiseLocal(const G4ParticleDefinition*,
...
/// \param p
///
void eBremsstrahlungRelModel::SetParticle(const G4ParticleDefinition* p)
{
  fPrimaryParticle     = p;
...
///
void eBremsstrahlungRelModel::SetupForMaterial(const G4ParticleDefinition*,
...
/// \return
///
G4double eBremsstrahlungRelModel::MinPrimaryEnergy(const G4Material*,
...
G4double
eBremsstrahlungRelModel::ComputeDEDXPerVolume(const G4Material* material,
...
G4double eBremsstrahlungRelModel::ComputeBremLoss(G4double tmax)
{
...
/// \return
///
G4double eBremsstrahlungRelModel::ComputeCrossSectionPerAtom(
                                                  const G4ParticleDefinition* p,
                                                  G4double kineticEnergy,
                                                  G4double Z,
                                                  G4double,
...
/// \return
///
G4double eBremsstrahlungRelModel::ComputeXSectionPerAtom(G4double tmin)
{
...
G4double
eBremsstrahlungRelModel::ComputeRelDXSectionPerAtom(G4double gammaEnergy)
{
  G4double dxsec = 0.0;
  if (gammaEnergy < 0.) {
    return dxsec;
...
G4double
eBremsstrahlungRelModel::ComputeDXSectionPerAtom(G4double gammaEnergy)
{
  G4double dxsec = 0.0;
  if (gammaEnergy < 0.) {
    return dxsec;
...
/// \param eps
///
void eBremsstrahlungRelModel::ComputeScreeningFunctions(G4double& phi1,
                                                          G4double& phi1m2,
                                                          G4double& psi1,
                                                          G4double& psi1m2,
                                                          const G4double gam,
...
///
void
eBremsstrahlungRelModel::SampleSecondaries(std::vector<G4DynamicParticle*>* vdp,
...
void eBremsstrahlungRelModel::InitialiseElementData()
{
...
void eBremsstrahlungRelModel::ComputeLPMfunctions(G4double& funcXiS,
                                                    G4double& funcGS,
                                                    G4double& funcPhiS,
...
void eBremsstrahlungRelModel::ComputeLPMGsPhis(G4double& funcGS,
                                                 G4double& funcPhiS,
...
void eBremsstrahlungRelModel::InitLPMFunctions()
{
...
void eBremsstrahlungRelModel::GetLPMFunctions(G4double& lpmGs,
                                                G4double& lpmPhis,
                                                const G4double sval)
{
