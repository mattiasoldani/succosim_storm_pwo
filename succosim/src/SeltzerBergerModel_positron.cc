...
G4Physics2DVector* SeltzerBergerModel_positron::gSBDCSData[]     = { nullptr };
G4SBBremTable*     SeltzerBergerModel_positron::gSBSamplingTable =   nullptr;
G4double           SeltzerBergerModel_positron::gYLimitData[]    = { 0.0     };

SeltzerBergerModel_positron::SeltzerBergerModel_positron(const G4ParticleDefinition* p,
                                             const G4String& nam)
: eBremsstrahlungRelModel_positron(p,nam), fIsUseBicubicInterpolation(false),
...
SeltzerBergerModel_positron::~SeltzerBergerModel_positron()
{
...
void SeltzerBergerModel_positron::Initialise(const G4ParticleDefinition* p,
...
G4String SeltzerBergerModel_positron::DirectoryPath() const {
  return "/brem_SB/br";
}

void SeltzerBergerModel_positron::ReadData(G4int izet, const char* path) {
...
G4double SeltzerBergerModel_positron::ComputeDXSectionPerAtom(G4double gammaEnergy)
{
...
void
SeltzerBergerModel_positron::SampleSecondaries(std::vector<G4DynamicParticle*>* vdp,
...
G4double
SeltzerBergerModel_positron::SampleEnergyTransfer(const G4double kinEnergy,
                                            const G4double tmin,
                                            const G4double tmax)
{
  static const G4double kMC2   = CLHEP::electron_mass_c2;
...
void SeltzerBergerModel_positron::InitialiseForElement(const G4ParticleDefinition*,
                                                 G4int izet)
{
...
void SeltzerBergerModel_positron::SetupForMaterial(const G4ParticleDefinition*,
                                             ...
                                             G4double kineticEnergy)
{
  ...
  fIsLPMActive        = false;  // MATTIA 2024: updating G4 version
}
