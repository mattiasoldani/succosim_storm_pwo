...
G4Physics2DVector* SeltzerBergerModel::gSBDCSData[]     = { nullptr };
G4SBBremTable*     SeltzerBergerModel::gSBSamplingTable =   nullptr;
G4double           SeltzerBergerModel::gYLimitData[]    = { 0.0     };

SeltzerBergerModel::SeltzerBergerModel(const G4ParticleDefinition* p,
                                             const G4String& nam)
: eBremsstrahlungRelModel(p,nam), fIsUseBicubicInterpolation(false),
...
SeltzerBergerModel::~SeltzerBergerModel()
{
...
void SeltzerBergerModel::Initialise(const G4ParticleDefinition* p,
...
G4String SeltzerBergerModel::DirectoryPath() const {
  return "/brem_SB/br";
}

void SeltzerBergerModel::ReadData(G4int izet, const char* path) {
...
G4double SeltzerBergerModel::ComputeDXSectionPerAtom(G4double gammaEnergy)
{
...
void
SeltzerBergerModel::SampleSecondaries(std::vector<G4DynamicParticle*>* vdp,
...
G4double
SeltzerBergerModel::SampleEnergyTransfer(const G4double kinEnergy,
                                            const G4double tmin,
                                            const G4double tmax)
{
  static const G4double kMC2   = CLHEP::electron_mass_c2;
...
void SeltzerBergerModel::InitialiseForElement(const G4ParticleDefinition*,
                                                 G4int izet)
{
...
void SeltzerBergerModel::SetupForMaterial(const G4ParticleDefinition*,
