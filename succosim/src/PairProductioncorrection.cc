...
G4double PairProductionCorrection::ComputeCorrectionPWO_001(G4double gammaEnergy)
{
	...
	else if ((energyG>=10.0000)&&(energyG<21.5000)){value=((1.2592240-0.9589112)/(21.5000-10.0000))*energyG + (1.2592240-((1.2592240-0.9589112)/(21.5000-10.0000))*21.5000);}
	else if ((energyG>=21.5000)&&(energyG<34.7250)){value=((1.6709040-1.2592240)/(34.7250-21.5000))*energyG + (1.6709040-((1.6709040-1.2592240)/(34.7250-21.5000))*34.7250);}
	else if ((energyG>=34.7250)&&(energyG<49.9337)){value=((2.1204000-1.6709040)/(49.9337-34.7250))*energyG + (2.1204000-((2.1204000-1.6709040)/(49.9337-34.7250))*49.9337);}
	else if ((energyG>=49.9337)&&(energyG<67.4231)){value=((2.5108250-2.1204000)/(67.4231-49.9337))*energyG + (2.5108250-((2.5108250-2.1204000)/(67.4231-49.9337))*67.4231);}
	else if ((energyG>=67.4231)&&(energyG<87.5373)){value=((2.8508030-2.5108250)/(87.5373-67.4231))*energyG + (2.8508030-((2.8508030-2.5108250)/(87.5373-67.4231))*87.5373);}
	else if ((energyG>=87.5373)&&(energyG<110.668)){value=((3.2056570-2.8508030)/(110.668-87.5373))*energyG + (3.2056570-((3.2056570-2.8508030)/(110.668-87.5373))*110.668);}
	else if ((energyG>=110.668)&&(energyG<137.268)){value=((3.3671530-3.2056570)/(137.268-110.668))*energyG + (3.3671530-((3.3671530-3.2056570)/(137.268-110.668))*137.268);}
	else if ((energyG>=137.268)&&(energyG<167.858)){value=((3.5898400-3.3671530)/(167.858-137.268))*energyG + (3.5898400-((3.5898400-3.3671530)/(167.858-137.268))*167.858);}
	else if ((energyG>=167.858)&&(energyG<203.032)){value=((3.7753490-3.5898400)/(203.032-167.858))*energyG + (3.7753490-((3.7753490-3.5898400)/(203.032-167.858))*203.032);}
	else if ((energyG>=203.032)&&(energyG<243.492)){value=((3.9491840-3.7753490)/(243.492-203.032))*energyG + (3.9491840-((3.9491840-3.7753490)/(243.492-203.032))*243.492);}
	else if ((energyG>=243.492)&&(energyG<290.016)){value=((4.1139870-3.9491840)/(290.016-243.492))*energyG + (4.1139870-((4.1139870-3.9491840)/(290.016-243.492))*290.016);}
	else if ((energyG>=290.016)&&(energyG<343.519)){value=((4.1527370-4.1139870)/(343.519-290.016))*energyG + (4.1527370-((4.1527370-4.1139870)/(343.519-290.016))*343.519);}
	else if ((energyG>=343.519)&&(energyG<405.047)){value=((4.3034930-4.1527370)/(405.047-343.519))*energyG + (4.3034930-((4.3034930-4.1527370)/(405.047-343.519))*405.047);}
	else if ((energyG>=405.047)&&(energyG<475.804)){value=((4.3230340-4.3034930)/(475.804-405.047))*energyG + (4.3230340-((4.3230340-4.3034930)/(475.804-405.047))*475.804);}
	else if ((energyG>=475.804)&&(energyG<557.174)){value=((4.4337000-4.3230340)/(557.174-475.804))*energyG + (4.4337000-((4.4337000-4.3230340)/(557.174-475.804))*557.174);}
	else if ((energyG>=557.174)&&(energyG<650.750)){value=((4.4570340-4.4337000)/(650.750-557.174))*energyG + (4.4570340-((4.4570340-4.4337000)/(650.750-557.174))*650.750);}
	else if ((energyG>=650.750)&&(energyG<758.363)){value=((4.5006280-4.4570340)/(758.363-650.750))*energyG + (4.5006280-((4.5006280-4.4570340)/(758.363-650.750))*758.363);}
	else if ((energyG>=758.363)&&(energyG<882.117)){value=((4.5069580-4.5006280)/(882.117-758.363))*energyG + (4.5069580-((4.5069580-4.5006280)/(882.117-758.363))*882.117);}
	else if ((energyG>=882.117)&&(energyG<1024.43)){value=((4.5030590-4.5069580)/(1024.43-882.117))*energyG + (4.5030590-((4.5030590-4.5069580)/(1024.43-882.117))*1024.43);}
...
G4double PairProductionCorrection::ComputeCorrectionPWO_100(G4double gammaEnergy)
{
	...
	if (energyG<10.0){value=0.8917249;}
