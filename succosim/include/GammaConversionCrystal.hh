...
#ifndef GammaConversionCrystal_h
#define GammaConversionCrystal_h 1
...
///
/// \brief The GammaConversionCrystal class класс конверсии гамма квантов в электрон-позитронные
/// пары, меняем в нем используемые электромагнитные модели на свои.
/// This is a class of conversion gamma to electron-positron pair. The electro-magnetic
/// models were changed into new models.
class GammaConversionCrystal : public G4VEmProcess

{
public:  // with description

  explicit GammaConversionCrystal(const G4String& processName ="convCrystal",
			     G4ProcessType type = fElectromagnetic);

  virtual ~GammaConversionCrystal();
...
protected:
  ...
  /// The changing was there
  virtual void InitialiseProcess(const G4ParticleDefinition*) override;

private:
     
  GammaConversionCrystal & operator=(const  GammaConversionCrystal &right) = delete;
  GammaConversionCrystal(const  GammaConversionCrystal&) = delete;
