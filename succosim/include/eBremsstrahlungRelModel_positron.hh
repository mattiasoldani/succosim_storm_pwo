...
///
class eBremsstrahlungRelModel_positron : public G4VEmModel {

public:

  explicit         eBremsstrahlungRelModel_positron(const G4ParticleDefinition* p=0,
                                             const G4String& nam="eBremLPM");

  virtual         ~eBremsstrahlungRelModel_positron();
...
private:
  ...
  eBremsstrahlungRelModel_positron& operator=(const eBremsstrahlungRelModel_positron& right) = delete;
  eBremsstrahlungRelModel_positron(const  eBremsstrahlungRelModel_positron&) = delete;
