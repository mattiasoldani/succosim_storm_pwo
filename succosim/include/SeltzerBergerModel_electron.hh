...
///
///
class SeltzerBergerModelElectron : public eBremsstrahlungRelModel_electron
{

public:

  explicit SeltzerBergerModelElectron(const G4ParticleDefinition* p = nullptr,
                                const G4String& nam = "eBremSB");

  virtual ~SeltzerBergerModelElectron();
...
private:
  ...
  SeltzerBergerModelElectron & operator=(const  SeltzerBergerModelElectron &right) = delete;
  SeltzerBergerModelElectron(const  SeltzerBergerModelElectron&) = delete;
