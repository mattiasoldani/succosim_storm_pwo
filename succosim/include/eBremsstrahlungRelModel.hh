...
///
class eBremsstrahlungRelModel : public G4VEmModel {

public:

  explicit         eBremsstrahlungRelModel(const G4ParticleDefinition* p=0,
                                             const G4String& nam="eBremLPM");

  virtual         ~eBremsstrahlungRelModel();
...
private:
  ...
  eBremsstrahlungRelModel& operator=(const eBremsstrahlungRelModel& right) = delete;
  eBremsstrahlungRelModel(const  eBremsstrahlungRelModel&) = delete;
