...
#ifndef eBremsstrahlungRelModel_h
#define eBremsstrahlungRelModel_h 1
...
///
/// \brief The eBremsstrahlungRelModel class Модель тормозного излучения
///This is an electromagnetic model of Bremsstrahlung
///
class eBremsstrahlungRelModel_electron : public G4VEmModel {

public:

  explicit         eBremsstrahlungRelModel_electron(const G4ParticleDefinition* p=0,
                                             const G4String& nam="eBremLPM");

  virtual         ~eBremsstrahlungRelModel_electron();
  ...
  virtual G4double ComputeDEDXPerVolume(const G4Material*,
    ...
    /// It is used class ComputeXSectionPerAtom for calculation cross section
  virtual G4double ComputeCrossSectionPerAtom(const G4ParticleDefinition*,
        ...
        /// The corrected functions are used here
...
protected:
  ...
  BremsstrahlungCorrection correction;
private:
    /// The corrected functions are used here
  ...
  eBremsstrahlungRelModel_electron& operator=(const eBremsstrahlungRelModel_electron& right) = delete;
  eBremsstrahlungRelModel_electron(const  eBremsstrahlungRelModel_electron&) = delete;
