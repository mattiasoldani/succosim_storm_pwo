...
#ifndef eBremsstrahlungAmorph_h
#define eBremsstrahlungAmorph_h 1
...
///
class eBremsstrahlungAmorph : public G4VEnergyLossProcess
{

public:

  explicit eBremsstrahlungAmorph(const G4String& name = "eBremeAmorph");

  virtual ~eBremsstrahlungAmorph();
...
private:
  ...
  eBremsstrahlungAmorph & operator=(const eBremsstrahlungAmorph &right) = delete;
  eBremsstrahlungAmorph(const eBremsstrahlungAmorph&) = delete;
