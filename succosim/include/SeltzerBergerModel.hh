...
///
///
class SeltzerBergerModel : public eBremsstrahlungRelModel
{

public:

  explicit SeltzerBergerModel(const G4ParticleDefinition* p = nullptr,
                                const G4String& nam = "eBremSB");

  virtual ~SeltzerBergerModel();
...
private:
  ...
  SeltzerBergerModel & operator=(const  SeltzerBergerModel &right) = delete;
  SeltzerBergerModel(const  SeltzerBergerModel&) = delete;
