...
#ifndef eBremsstrahlung_positron_h
#define eBremsstrahlung_positron_h 1
...
///
class eBremsstrahlung_positron : public G4VEnergyLossProcess
{

public:

  explicit eBremsstrahlung_positron(const G4String& name = "eBrem_positron");

  virtual ~eBremsstrahlung_positron();
...
private:
  ...
  eBremsstrahlung_positron & operator=(const eBremsstrahlung_positron &right) = delete;
  eBremsstrahlung_positron(const eBremsstrahlung_positron&) = delete;
