...
#ifndef GammaConversionAmorph_h
#define GammaConversionAmorph_h 1
...
///
/// \brief The GammaConversionAmorph class класс конверсии гамма квантов в электрон-позитронные
...
class GammaConversionAmorph : public G4VEmProcess

{
public:  // with description

  explicit GammaConversionAmorph(const G4String& processName ="convAmorph",
			     G4ProcessType type = fElectromagnetic);

  virtual ~GammaConversionAmorph();
...
private:
  ...
  GammaConversionAmorph & operator=(const  GammaConversionAmorph &right) = delete;
  GammaConversionAmorph(const  GammaConversionAmorph&) = delete;
